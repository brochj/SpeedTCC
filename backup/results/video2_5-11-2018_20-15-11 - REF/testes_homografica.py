...
# ---- Speed Values -----------------------------------------------------------
CF_LANE1 = 2.15 #2.10  # default 2.5869977 # Correction Factor
...
KERNEL_ERODE = np.ones((r(10), r(10)), np.uint8)  # Default (r(12), r(12))
KERNEL_DILATE = np.ones((r(130), r(400)), np.uint8)  # Default (r(130), r(400))
