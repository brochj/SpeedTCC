...
class Tracking:
    ...
    def remove_expired_track(
        self, frame_time, vehicle_speed, blob_track_timeout=config.BLOB_TRACK_TIMEOUT
    ):
        if self.tracked_blobs:
            ...
            if frame_time - self.tracked_blobs["last_seen"] > blob_track_timeout:
                print(
                    "Removing expired trail tracking from {} | id: {} |".format(
