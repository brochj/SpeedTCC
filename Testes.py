...
#                out = cv2.rectangle(out, (x, y), (x + w, y + h), GREEN, 2) # printa na mask
                cv2.rectangle(frame, (x, y), (x + w, y + h), GREEN, 2)  # printa na frame
#                if frameCount == ARTG_FRAME:
#                    cv2.imwrite('retanguloc.png', crop(out))
#                    cv2.imwrite('retang_frame.png', crop(frame))
...
#                print_xml_values(frame, RESIZE_RATIO, dict_lane1, dict_lane2, dict_lane3)
